...
def gen( n,n1,n2,ns,n1s,n2s,m,a):
...
def final(n,n1,n2,ns,n1s,n2s,m,a):
    return gen(n,n1,n2,ns,n1s,n2s,m,a)*gen2(n,n1,n2,ns,n1s,n2s,m)
print(final(3,2,0,2,0,1,0,1))
